...
interface SelectorUbicacionClienteProps {
...
export default function SelectorUbicacionCliente({ 
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
                ...
                {!ubicacion && (
                    <p className="text-sm text-blue-600 mt-2">
                        📝 <strong>Tip:</strong> La dirección se buscará automáticamente en el mapa.
                    </p>
                )}
            </div>
